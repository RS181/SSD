...
public class BlockChainProgram {
    ...
    public static void main(String[] args) {
        ...
        firstTransactions.add(new Transaction("user1", Transaction.TransactionType.START_AUCTION, "AUC123", 0, System.currentTimeMillis()));
        firstTransactions.add(new Transaction("user2", Transaction.TransactionType.PLACE_BID, "AUC123", 100.50, System.currentTimeMillis()));
        firstTransactions.add(new Transaction("user1", Transaction.TransactionType.PLACE_BID, "AUC123", 150.75, System.currentTimeMillis()));
        ...
        secondTransactions.add(new Transaction("user1", Transaction.TransactionType.START_AUCTION, "batatas", 0, System.currentTimeMillis()));
        secondTransactions.add(new Transaction("user1", Transaction.TransactionType.CLOSE_AUCTION, "AUC123", 0, System.currentTimeMillis()));
        ...
        thirdTransactions.add(new Transaction("user1", Transaction.TransactionType.START_AUCTION, "AUC123", 0, System.currentTimeMillis()));
